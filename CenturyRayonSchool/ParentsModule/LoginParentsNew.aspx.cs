...
{
    public partial class LoginParentsNew : System.Web.UI.Page
    {
        ...
        protected void btn1_Login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    con.Open();
                    query = "select (mname+' '+lname) as fullname,GRNO,std,ParentPassword,academicyear,cid as userid from studentmaster where academicyear='" + year + "' and ParentPassword='" + password + "' and grno='" + GRNO + "'";
