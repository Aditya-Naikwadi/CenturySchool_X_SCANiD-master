...
<head>
    ...
    <style>
        ...
        .card-footer {
            padding: 4.75rem 3.25rem !important;
        }
    </style>
                    ...
                    <form runat="server">
                        <asp:Panel ID="LoginPanel" runat="server" DefaultButton="btn1_Login">
                            ...
                            <div class="input-group form-group">
                                ...
                                <asp:TextBox ID="Upass" runat="server" CssClass="form-control" TextMode="Password" placeholder="password"></asp:TextBox>

                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Upass" ErrorMessage="Please Enter Your Password"
                                ForeColor="Red" ValidationGroup="LoginGroup"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                ...
                                <asp:Button ID="btn1_Login" runat="server" Text="Login" CssClass="btn float-right login_btn" OnClick="btn1_Login_Click" ValidationGroup="LoginGroup" />
                            </div>
                        </asp:Panel>

                        <asp:Panel ID="ForgotPasswordPanel" runat="server" Visible="false" DefaultButton="btnResetPassword">
                            <div class="input-group form-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                </div>
                                <asp:TextBox ID="txtForgotUsername" runat="server" CssClass="form-control" placeholder="Enter your username"></asp:TextBox>
                            </div>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtForgotUsername" ErrorMessage="Please Enter Your Username"
                                ForeColor="Red" ValidationGroup="ForgotPasswordGroup"></asp:RequiredFieldValidator>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtNewPassword" ErrorMessage="Please Enter New Password"
                                ForeColor="Red" ValidationGroup="ForgotPasswordGroup"></asp:RequiredFieldValidator>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtConfirmPassword" ErrorMessage="Please Confirm Password"
                                ForeColor="Red" ValidationGroup="ForgotPasswordGroup"></asp:RequiredFieldValidator>
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtNewPassword" ControlToValidate="txtConfirmPassword"
                                ErrorMessage="Passwords do not match" ForeColor="Red" ValidationGroup="ForgotPasswordGroup"></asp:CompareValidator>

                            <div class="form-group" style="margin-top: -10px;">
                                <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btn login_btn" OnClick="btnBack_Click" CausesValidation="false" />
                                <asp:Button ID="btnResetPassword" runat="server" Text="Reset" CssClass="btn float-right login_btn" OnClick="btnResetPassword_Click" ValidationGroup="ForgotPasswordGroup" />
                            </div>
                        </asp:Panel>
                        <div class="card-footer">
                            <div class="d-flex justify-content-center">
                                <asp:LinkButton ID="lnkForgotPassword" runat="server" Text="Forgot your password?" ForeColor="White" OnClick="lnkForgotPassword_Click" CausesValidation="false" Visible="true"></asp:LinkButton>
