<%@ Page Title="" Language="C#" MasterPageFile="~/LCModule/LeavingMaster.Master" AutoEventWireup="true" CodeBehind="LCPrint.aspx.cs" Inherits="CenturyRayonSchool.LCModule.LCPrint" Async="true"%>
                        ...
                        <asp:GridView AutoGenerateColumns="False" ID="GridCollection" runat="server" ShowHeaderWhenEmpty="True" CssClass="table table-lg table-striped table-responsive mt-3 ftrow">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText=" Print" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                    <ItemTemplate>
                                      <asp:HyperLink NavigateUrl='<%#getDownloadUrl(Eval("Grno").ToString(),Eval("div").ToString(),Eval("std").ToString(),Eval("Section").ToString(),Eval("academicyear").ToString())%>' runat="server" Text="Print" CssClass="btn btn-success" Target="_blank" />
                                    </ItemTemplate>
                                </asp:TemplateField>
