<%@ Page Title="" Language="C#" MasterPageFile="~/LCModule/LeavingMaster.Master" AutoEventWireup="true" CodeBehind="BulkLCGenerate.aspx.cs" Inherits="CenturyRayonSchool.LCModule.BulkLCGenerate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-3" style="margin-top: 16px;">
                        <button runat="server" id="Button1" class="btn btn-saveData mt-2" onserverclick="Button1_ServerClick" onclientclick="showwaitingdialogue();" style="width:60%;"><i class="fas fa-angle-double-down mr-2"></i>Generate LC</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (e) {
            ...
            $("#menu_lcgenrate").addClass("active");
        ...
        function showwaitingdialogue() {
            ...
            waitingDialog.show('Generating LC');
