<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditEvents.aspx.cs" Inherits="CenturyRayonSchool.EditEvents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="display:none;">
         ...
         <asp:ScriptManager ID="SCPTMGR" runat="server" EnableCdn="true"></asp:ScriptManager>
              <div class="row mb-2">
                        <div class="col-md-12">
                             <asp:Label ID="lblformtitle" Text="Edit Events Data" runat="server" CssClass="font-weight-bolder " style="color:navy;font-size:xx-large;" />
                        </div>
              ...
              <div class="row">
                          <div class="col-md-4">
                               ...
                               <asp:TextBox runat="server"  class="fromdatepicker form-control" ID="txtstartdate" readonly="true"></asp:TextBox>
                             ...
                             <div class="col-md-4">
                               ...
                               <asp:TextBox runat="server"  class="fromdatepicker form-control" ID="txtenddate" readonly="true"></asp:TextBox>
           ...
           <div class="row mt-1">
                ...
                <div class="col-md-4 ">
                               ...
                               <asp:label ID="thumb_filename" runat="server" />
                            <asp:label ID="thumb_filepath" runat="server" />
                        </div>
                ...
                <div class="col-md-4 ">
                    ...
                    <asp:label ID="filepath" runat="server" />
                        </div>   
               </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.fromdatepicker').datepicker({
                ...
                //alert($("#ContentPlaceHolder1_txtselecteddate").val());
            });
