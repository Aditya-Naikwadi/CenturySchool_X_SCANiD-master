<%@ Page Title="" Language="C#" MasterPageFile="~/MarksheetModule/Marksheet.Master" AutoEventWireup="true" CodeBehind="SubjectMarks8to9.aspx.cs" Inherits="CenturyRayonSchool.MarksheetModule.SubjectMarks8to9" %>
                    ...
                    <div class="col-md-12">
                        <div style="width:100%;">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Written " HeaderStyle-BackColor="#1CB5E0" HeaderStyle-CssClass="ftrow1" >
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox runat="server" class="form-control" ID="Written" Text='<%#Eval("Written").ToString()%>'  OnTextChanged="Written_TextChanged" AutoPostBack="true" Width="120px" Style="text-align:center"></asp:TextBox>
                                        </div>                            
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Orals " HeaderStyle-BackColor="#1CB5E0" HeaderStyle-CssClass="ftrow1" >
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox runat="server" class="form-control" ID="oralsprac" Text='<%#Eval("oralsprac").ToString()%>' OnTextChanged="oralsprac_TextChanged" AutoPostBack="true" Width="120px" Style="text-align:center"></asp:TextBox>
                                        </div>                            
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="TOTAL" HeaderStyle-BackColor="#1CB5E0" HeaderStyle-CssClass="ftrow1" ItemStyle-CssClass="col-id">
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox runat="server" class="form-control" ID="total" Text='<%#Eval("total").ToString()%>'   AutoPostBack="true" Width="120px" Style="text-align:center;  background-color:#fef6db"></asp:TextBox>
                                        </div>                            
                                    </ItemTemplate>
    ...
    <div class="modal fade" id="infomessagemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
     ...
     <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            $("#menu_SubjectMarks8to9").addClass("active");
