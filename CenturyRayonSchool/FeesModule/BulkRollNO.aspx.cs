...
{
    public partial class BulkRollNO : System.Web.UI.Page
    {
        ...
        public void loadFormControl()
        {
            ...
            {
                Log.Error("BulkRollNo.loadFormControl", ex);
            }
            finally
            {
        ...
        protected void cmbDiv_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                Log.Error("BulkRollNo.cmbDiv_SelectedIndexChanged", ex);
            }
            finally
            {
                if (con != null) { con.Close(); }
        ...
        public void fillGridView()
        {
            ...
            {
                Log.Error("BulkRollNo.fillGridView", ex);
            }
            finally
            {
                if (con != null) { con.Close(); }
        ...
        protected void newrollno_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                Log.Error("BulkRollNo.newrollno_TextChanged", ex);
