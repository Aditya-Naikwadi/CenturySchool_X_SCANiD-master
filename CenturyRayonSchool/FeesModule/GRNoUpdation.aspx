<%@ Page Title="" Language="C#" MasterPageFile="~/FeesModule/Master.Master" AutoEventWireup="true" CodeBehind="GRNoUpdation.aspx.cs" Inherits="CenturyRayonSchool.FeesModule.GRNoUpdation" %>
                ...
                <div class="row">
                 ...
                 <div class="row">
                     <div class="col-md-12">
                            ...
                            <Columns>
                                <asp:BoundField DataField="oldGRNO" HeaderText="OLD GRNO " HeaderStyle-BackColor="#1CB5E0" HeaderStyle-CssClass="ftrow1 fixed-header col-id-no" ItemStyle-CssClass="col-id-no" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                ...
                                <asp:BoundField DataField="schoolsection" HeaderText="School Section " HeaderStyle-BackColor="#1CB5E0" HeaderStyle-CssClass="ftrow1 fixed-header col-id-no" ItemStyle-CssClass="col-id-no" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                               
                                </asp:BoundField>
                                                               
                                <asp:TemplateField HeaderText="NEW GRNO" HeaderStyle-BackColor="#1CB5E0" HeaderStyle-CssClass="ftrow1"  HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox runat="server" class="form-control" ID="newgrno" Text='<%#Eval("newgrno").ToString()%>' OnTextChanged="newgrno_TextChanged" AutoPostBack="true" Width="100px" Style="text-align:center"></asp:TextBox>
                                        </div>                            
                                    </ItemTemplate>
                                 ...
                                 <asp:TemplateField HeaderText="Status" HeaderStyle-BackColor="#1CB5E0" HeaderStyle-CssClass="ftrow1" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                    <ItemTemplate>
                                        <div>
                                            <asp:TextBox runat="server" class="form-control" ID="grstats" Text='<%#Eval("grstats").ToString()%>' AutoPostBack="true" Width="200px" Style="text-align:center;" ReadOnly="true"></asp:TextBox>
                                         </div>                            
                                    </ItemTemplate>
