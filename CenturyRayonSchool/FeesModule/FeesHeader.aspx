<%@ Page Title="" Language="C#" MasterPageFile="~/FeesModule/Master.Master" AutoEventWireup="true" CodeBehind="FeesHeader.aspx.cs" Inherits="CenturyRayonSchool.FeesModule.FeesHeader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="card card-sh">
            <div class="card-header">
                <a href="Dashboard.aspx" class="mr-2 text-secondary"><i class="fas fa-arrow-left"></i></a>Fee Headers
            ...
            <div class="card-body margin-rows">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <label for="txtFeesHeader" class="form-label mb-1">Header Name</label>
                        <asp:TextBox ID="txtFeesHeader" runat="server" type="text" class="form-control"></asp:TextBox>
                    </div>
                    <div class="col-md-4 d-flex align-items-end">
                        <Button runat="server" ID="SaveHeader" class="btn btn-save mt-2" OnServerClick="SaveHeader_ServerClick"><i class="fas fa-save mr-2"></i>Save Header</Button>
                    </div>
                    <div class="col-md-12">
                        <asp:GridView CssClass="table table-sm table-bordered mt-3" AutoGenerateColumns="false" ID="gridHeaders" runat="server" OnRowCommand="gridHeaders_RowCommand" Width="100%" ShowHeaderWhenEmpty="true">
                            <Columns>
                                <asp:BoundField DataField="Fee_Code" HeaderText=" Sr. No " ItemStyle-Width="10%" HeaderStyle-Width="10%" />
                                <asp:BoundField DataField="Fee_Header" HeaderText=" Fees Header "  ItemStyle-Width="60%" HeaderStyle-Width="60%"/>
                                <asp:TemplateField HeaderText=" Action"  ItemStyle-Width="30%" HeaderStyle-Width="30%">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton runat="server" ID="btnDelete" CssClass="btn btn-delete mt-2" CommandName="deletefeesheader" CommandArgument="<%# ((GridViewRow) Container).RowIndex%>" OnClientClick="Confirm()"><i class="fas fa-trash mr-2"></i>Delete</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
  ...
  <div class="modal-dialog">
    ...
    <script type="text/javascript">
        $(document).ready(function (e) {
            ...
            $("#menu_feesHeader").addClass("active");
        });
        ...
        function Confirm() {
            ...
            if (confirm("Are you sure you want to Delete Fee Header. Please Contact Administrator For Changes in Fees Header.")) {
