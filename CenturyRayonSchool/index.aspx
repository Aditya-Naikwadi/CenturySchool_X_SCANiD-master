<%@ Page Title="" Language="C#" MasterPageFile="~/WebsiteMaster.Master" AutoEventWireup="true" CodeFile="index.aspx.cs"
  Inherits="CenturyRayonSchool.index" %>
  ...
  <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- ========== HERO CAROUSEL SECTION ========== -->
    <section class="section-wrapper no-padding">
    ...
    <!-- ========== ANNOUNCEMENTS & UPDATES SECTION REMOVED ========== -->
