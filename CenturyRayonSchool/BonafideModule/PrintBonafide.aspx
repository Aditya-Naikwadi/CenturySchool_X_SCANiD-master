<%@ Page Title="" Language="C#" MasterPageFile="~/BonafideModule/BonafideMaster.Master" AutoEventWireup="true" CodeBehind="PrintBonafide.aspx.cs" Inherits="CenturyRayonSchool.BonafideModule.PrintBonafide" Async="true"%>
                        ...
                        <asp:GridView AutoGenerateColumns="False" ID="GridCollection" runat="server" ShowHeaderWhenEmpty="True" CssClass="table table-lg table-striped table-responsive mt-3 ftrow">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText=" Print" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                    <ItemTemplate>
                                      <asp:HyperLink NavigateUrl='<%#getBonafideDownloadUrl(Eval("Grno").ToString(),Eval("div").ToString(),Eval("std").ToString(),Eval("Section").ToString())%>' runat="server" Text="Print" CssClass="btn btn-success" Target="_blank" />
                                    </ItemTemplate>
                                </asp:TemplateField>
